...
export class ContactsServiceProvider {
  ...
  getContact(id: string) {
    ...
    return oauth.login().then(oauthResult => {
      ...
      return service.query(
        `SELECT Id, FirstName, LastName, Name, Email, MobilePhone FROM Contact WHERE Id = '${id}'`
      );
    });
  }
    ...
    if (contact.Id) {
      ...
      return new Promise(function(resolve, reject) {
        force.login(function() {
          ...
          force.update("contact", contact, function(result) {
      ...
      return new Promise(function(resolve, reject) {
        force.login(function() {
          console.log("auth success");
          force.create("contact", contact, function(result) {
